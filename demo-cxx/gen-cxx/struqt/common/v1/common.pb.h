...
class Dummy final :
 ...
 public:
  ...
  Dummy(::google::protobuf::Arena* arena, const Dummy& from);
  public:
  ...
  void set_allocated_version_tag(std::string* value);
...
inline const ::google::protobuf::Timestamp& GetServerInfoResponse::started_at() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::Timestamp* GetServerInfoResponse::mutable_started_at() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::Timestamp& GetServerInfoResponse::timestamp() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::Timestamp* GetServerInfoResponse::mutable_timestamp() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline PROTOBUF_ALWAYS_INLINE void Dummy::set_version_tag(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.version_tag_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:struqt.common.v1.Dummy.version_tag)
}
inline std::string* Dummy::mutable_version_tag() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Dummy::_internal_set_version_tag(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.version_tag_.Set(value, GetArena());
}
inline std::string* Dummy::_internal_mutable_version_tag() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.version_tag_.Mutable( GetArena());
}
...
inline void Dummy::set_allocated_version_tag(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.version_tag_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.version_tag_.IsDefault()) {
          _impl_.version_tag_.Set("", GetArena());
        }
