...
DemoOption::DemoOption(const DemoOption& from) : ::google::protobuf::Message() {
...
const ::google::protobuf::Message::ClassData*DemoOption::GetClassData() const { return &_class_data_; }
