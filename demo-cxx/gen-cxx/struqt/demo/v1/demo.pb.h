...
inline const ::struqt::demo::v1::JsonRpcErrorObject& JsonRpcResponse::_internal_error() const {
  return one_of_case() == kError ? *_impl_.one_of_.error_ : reinterpret_cast<::struqt::demo::v1::JsonRpcErrorObject&>(::struqt::demo::v1::_JsonRpcErrorObject_default_instance_);
}
inline const ::struqt::demo::v1::JsonRpcErrorObject& JsonRpcResponse::error() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void JsonRpcResponse::unsafe_arena_set_allocated_error(::struqt::demo::v1::JsonRpcErrorObject* value) {
  // We rely on the oneof clear method to free the earlier contents
  // of this oneof. We can directly use the pointer we're given to
  // set the new value.
  clear_one_of();
...
inline ::struqt::demo::v1::JsonRpcErrorObject* JsonRpcResponse::_internal_mutable_error() {
  if (one_of_case() != kError) {
    clear_one_of();
    set_has_error();
    _impl_.one_of_.error_ = CreateMaybeMessage<::struqt::demo::v1::JsonRpcErrorObject>(GetArena());
  }
  return _impl_.one_of_.error_;
}
inline ::struqt::demo::v1::JsonRpcErrorObject* JsonRpcResponse::mutable_error() ABSL_ATTRIBUTE_LIFETIME_BOUND {
