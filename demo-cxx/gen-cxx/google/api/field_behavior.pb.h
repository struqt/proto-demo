...
constexpr FieldBehavior FieldBehavior_MAX = static_cast<FieldBehavior>(7);
constexpr int FieldBehavior_ARRAYSIZE = 7 + 1;
...
inline const std::string& FieldBehavior_Name(FieldBehavior value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<FieldBehavior_descriptor,
                                                 0, 7>(
