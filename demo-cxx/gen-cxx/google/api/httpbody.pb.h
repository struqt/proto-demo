...
PROTOBUF_NAMESPACE_OPEN
template <>
::google::api::HttpBody* Arena::CreateMaybeMessage<::google::api::HttpBody>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class HttpBody final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::PROTOBUF_NAMESPACE_ID::Any>& _internal_extensions() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::PROTOBUF_NAMESPACE_ID::Any>* _internal_mutable_extensions();
  public:
